...
import ManageApartmentdetailsRightSide from './ManageApartmentdetailsRightSide';
import ManageApartmentdetailsAddMoreOverOthers from './ManageApartmentdetailsAddMoreOverOthers';

const ManageAppartmentsView = () => {
    ...
    return (
        <div>
            <Link to={"/manage-apartments"} className="text-2xl flex items-center mt-10">
            ...
            <div className='flex items-start gap-10'>
                ...
                <div className='w-full'>
                    <ManageApartmentdetailsRightSide />
                    <ManageApartmentdetailsAddMoreOverOthers />
                </div>
            </div>
...
export default ManageAppartmentsView;

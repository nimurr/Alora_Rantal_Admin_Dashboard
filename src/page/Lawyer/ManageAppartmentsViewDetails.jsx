...
export default function ManageAppartmentsViewDetails() {
    ...
    return (
        <div className="py-6 min-h-screen">
            ...
            <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
                <Link to="/manage-apartments" className="flex items-center gap-3">
                    <FaArrowLeft className="cursor-pointer" />
                    <span className="text-2xl font-semibold">Unit list details</span>
                </Link>

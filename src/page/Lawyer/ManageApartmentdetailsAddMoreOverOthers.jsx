...
export default function ManageApartmentdetailsAddMoreOverOthers() {
    return (
        <div>
                    ...
                    </div>
                    {
                        [1, 2, 3, 4].map((item) => (
                            <div className='p-3 flex items-start justify-between gap-5 m-2 rounded-lg border border-[#2cb5eb]  capitalize taxt-base'>
                                ...
                                <Link to={`/manage-apartments/view/details/${item}`} className='w-1/2 bolck text-end'>Details</Link>
                            </div>
                        ))
                    }
                </div>
